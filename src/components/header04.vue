...
<div class="header">
    <div class="heaw">
        <div class="fl"><router-link :to="{ name: 'member'}"><i class="iconfont icon-pros02 zsm mlin"></i></router-link></div>
        <div class="fm">比分宝典</div>
...
.heaw{
    background: -webkit-linear-gradient(#b1ba7a, #858c5c);
    background: -o-linear-gradient(#b1ba7a, #858c5c);
    background: -moz-linear-gradient(#b1ba7a, #858c5c);
    background: linear-gradient(#b1ba7a, #858c5c);
    display: block;
    position: fixed;
    z-index: 100;
    width:100%;
