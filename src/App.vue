...
import header from '@/components/header04';
...
　　},
    $route(to,from){
        ...
        if(to.path == '/newsMore' || to.path == '/newlists1' || to.path == '/newlists2' || to.path == '/newlists3' || to.path == '/newlists4' || to.path == '/newlists5' || to.path == '/newlists6' || to.path == '/newlists7'){ //新闻中心
            this.isNews = true;
            this.isBanner = false;
        }else{
            this.isNews = false;
...
@font-face {
  ...
  src: url('//at.alicdn.com/t/font_880675_zw1vlb9r8jm.eot');
  src: url('//at.alicdn.com/t/font_880675_zw1vlb9r8jm.eot?#iefix') format('embedded-opentype'),
  url('//at.alicdn.com/t/font_880675_zw1vlb9r8jm.woff') format('woff'),
  url('//at.alicdn.com/t/font_880675_zw1vlb9r8jm.ttf') format('truetype'),
  url('//at.alicdn.com/t/font_880675_zw1vlb9r8jm.svg#iconfont') format('svg');
}
.iconfont {
